...
if(count($_POST)!=0){
  ...
  extract($_POST);
  extract($_GET);
  $query = "UPDATE staff_dept SET StaffID = '$StaffID', DeptID = '$DeptID' WHERE ID='$ID'";
...
<head>
  ...
  <title>Update Staff Department Info</title>
          ...
          <div class = "container">
            <div class = "card">
              <div class = "card-header bg-dark">
                <h1 class="text-center text-white">Update Staff Department Information</h1>
              </div>
