...
if(count($_POST)!=0){
  ...
  extract($_POST);
  $query="INSERT INTO artdept(ArtDeptID,ArtDeptName) VALUES ('$ArtDeptID','$ArtDeptName')";
...
<head>
  ...
  <title>Insert Art Department</title>
          ...
          <div class = "container">
            <div class = "card">
              <div class = "card-header bg-dark">
                <h1 class="text-center text-white">Insert Art Department</h1>
              </div>
              ...
              <div class = "form-group">
                <label for="ArtDeptName">Department Name</label>
