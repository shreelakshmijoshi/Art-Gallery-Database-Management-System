  ...
  <div class = "container">
    <div class = "row">
      <div class = "clo-lg-6 m-auto">
          ...
          <div class = "container">
            <div class = "card">
              ...
              <!-- <div class = "form-group">
                ...
                <input type = "number" class = "form-control" name="TranID" min=1>
              </div> -->
              <div class = "form-group">
        ...
        <form method = "POST" action="ticketSale1_display2.php">
          <div class = "card-header bg-light">
            <h1 class="text-center text-dark">Transactions for the given dates</h1>
          </div>
          <div class = "form-group">
          ...
          <br>
          <button type="submit" class="btn btn-secondary">Display Transaction</button>
    <!--     <div class= "d-grid gap-2 col-6 mx-auto" name="display2">
           <button type="submit" class="btn btn-secondary" name="submit2" value="Display transaction"/> -->
      <!--      <h5><a href="ticketSale1_display2.php"><input type="button" class="btn btn-secondary" value="Display Transaction"></a></h5> -->
      <!--     <button type="submit" class="btn btn-secondary" name="submit2" value="Display transaction"/> -->
        </form>
      </div>
    </div>
