...
if(count($_POST)!=0){
  ...
  extract($_POST);
  $query="INSERT INTO department(DeptID,Name) VALUES ('$DeptID','$Name')";
          ...
          <div class = "container">
            <div class = "card">
              <div class = "card-header bg-dark">
                <h1 class="text-center text-white">Insert Department</h1>
              </div>
            ...
            <div class= "d-grid gap-2 col-6 mx-auto" name="display">
              <h5><a href="dept_display.php"><input type="button" class="btn btn-primary" value="Display"></a></h5>
            </div>
          </div>
        </form>
      </div>
